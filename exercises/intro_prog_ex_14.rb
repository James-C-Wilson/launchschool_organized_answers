# In exercise 12, 
# we manually set the contacts hash values one by one. Now, programmatically loop or 
# iterate over the contacts hash from exercise 12, and populate the associated data from the 
